...
<script src="js/common-new.jl.js"></script>
...
<!--Add chart window-->
    <div id="addChartModal" class="settings-modal">
        <!-- Modal content -->
        <div class="settings-modal-content widget-font">
            <span id="settingsCloseBtn" class="settings-close"><img src="img/delete.png"></span>
            <p class="settings-modal-title">Add Chart</p>
            ...
            <div id="settingsModelDateDiv" class="w3-row widget-color">
                ...
                <div class="w3-col w3-container" style="width:30%">
                    <input type="text" id="ipPortText" >
                </div>
            </div>
            <button id="settings-modal-button" class="portal-button" onclick="addGraph()">Add</button>
    ...
    <div class="w3-content" style="max-width:100%">
        ...
        <header class="portal-header widget-color w3-padding-48">
            ...
            <button id="addWidgetButton" class="portal-button" onclick="">ADD PANE</button>
